...
\begin{egg}
The logistic mapping $f_4:I \to I$, where $I=[0,1]$, is chaotic. 
\end{egg}
...
hyperbolic set for the logistic mapping $f_\mu$.  The behaviour of
...
of choatic mapping can be extended to any topological space $I$, not just
intervals.}.
\end{egg}
