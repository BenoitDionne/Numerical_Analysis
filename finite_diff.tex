...
$\displaystyle j \geq 0$ is $\ell^2$-stable, then
...
$\displaystyle \ell^2$-stable and consistent, then it is $\ell^2$-convergent. 
\end{theorem}
...
Using Definition~\ref{fdmStableDefNo4} to determine $\displaystyle
\ell^2$ stability may seem to be the next reasonable option but that
requires a nice matrix (usually ``near'' diagonal) to be able to determine the
