...
\usepackage{bm}          % Using \bm in the title of a chapter,
                         ...
                         % definition of \BKM@title."  \mathbg{}
...
\newcommand{\titlePage}{
  ...
  \begin{titlepage}
    \newsavebox{\caversea}
    \savebox{\caversea}{\includegraphics[width=7in]{images/cover_sea}}
    % \newsavebox{\windmill}
    % \savebox{\windmill}{\includegraphics[width=2.5in]{images/cover_windmill}}
    \newsavebox{\bridge}
    \savebox{\bridge}{\includegraphics[width=2.5in]{images/cover_bridge}}
...
\newcommand{\Sone}{S^1}
\newcommand{\torus}[1]{\displaystyle \mathbf{T}^{#1}}
...
\newcommand{\dydxn}[3]{\displaystyle \frac{\mathrm{d}^{#3}{#1}}%
...
% Reverse diagonal three dots
\newcommand{\iddots}{\hbox{\raise-1pt\hbox{.}\kern1.9pt\raise2.7pt\hbox{.}%
\kern1.9pt\raise6.4pt\hbox{.}}}
